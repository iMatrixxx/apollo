 ...
 */
class  Akeman181: public ::apollo::drivers::canbus::ProtocolData<
 ...
 public:
   ...
   */
  Akeman181 *set_pedal(double pcmd);

  /**
   * @brief set pedal_enable_ to true
   * @return a this pointer to the instance itself
   */
  Akeman181 *set_enable();

  /**
   * @brief set pedal_enable_ to false
   * @return a this pointer to the instance itself
   */
  Akeman181 *set_disable();

  /**
   * zhxf 20240725
   * @brief 设置阿克曼小车x、y、z轴速度
   * @return a this pointer to the instance itself
   */
  Akeman181 *set_control_info(double vel_x, double vel_z);
 ...
 private:
   ...
   * @return a this pointer to the instance itself
   */
  Akeman181 *enable_boo_cmd();

  /**
   * @brief disable boo command
   * @return a this pointer to the instance itself
   */
  Akeman181 *disable_boo_cmd();
 ...
 private:
  ...
  double linear_vel_x_ = 0.0; //zhxf 20240725 阿克曼小车X轴速度
  double linear_vel_z_ = 0.0; //zhxf 20240725 阿克曼小车Z轴速度
};
